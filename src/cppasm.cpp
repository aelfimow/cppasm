...
Instruction9_Type1 VPBROADCASTB { asmout, "vpbroadcastb" };
Instruction9_Type2 VPBROADCASTW { asmout, "vpbroadcastw" };
Instruction9_Type3 VPBROADCASTD { asmout, "vpbroadcastd" };
Instruction9_Type4 VPBROADCASTQ { asmout, "vpbroadcastq" };
Instruction3_Type10 VEXTRACTPS { asmout, "vextractps" };
Instruction2_Type34 VEXTRACTF128 { asmout, "vextractf128" };
Instruction2_Type34 VEXTRACTI128 { asmout, "vextracti128" };
Instruction2_Type33 VEXTRACTF32X8 { asmout, "vextractf32x8" };
Instruction2_Type33 VEXTRACTF64X4 { asmout, "vextractf64x4" };
Instruction2_Type33 VEXTRACTI32X8 { asmout, "vextracti32x8" };
Instruction2_Type33 VEXTRACTI64X4 { asmout, "vextracti64x4" };
Instruction2_Type35 VINSERTF128 { asmout, "vinsertf128" };
Instruction2_Type35 VINSERTI128 { asmout, "vinserti128" };
Instruction4_Type28 VINSERTI32X4 { asmout, "vinserti32x4" };
Instruction4_Type28 VINSERTI64X2 { asmout, "vinserti64x2" };
Instruction2_Type42 VINSERTI32X8 { asmout, "vinserti32x8" };
Instruction2_Type42 VINSERTI64X4 { asmout, "vinserti64x4" };
...
Instruction12_Type5 VPERMQ { asmout, "vpermq" };
...
Instruction9_Type5 VALIGND { asmout, "valignd" };
Instruction9_Type6 VALIGNQ { asmout, "valignq" };
...
Instruction9_Type9 VCVTPS2UDQ { asmout, "vcvtps2udq" };
...
const std::string_view no_suffix { "" };
const std::string_view suffix_bw { "bw" };
const std::string_view suffix_bl { "bl" };
const std::string_view suffix_bq { "bq" };
const std::string_view suffix_wl { "wl" };
const std::string_view suffix_wq { "wq" };
const std::string_view suffix_lq { "lq" };
const std::string_view suffix_m8 { "b" };
const std::string_view suffix_m16 { "w" };
const std::string_view suffix_m32 { "l" };
const std::string_view suffix_m64 { "q" };
const std::string_view suffix_m128 { "x" };
const std::string_view suffix_m256 { "y" };
const std::string_view suffix_m32fp { "s" };
const std::string_view suffix_m64fp { "l" };
const std::string_view suffix_m80fp { "t" };
const std::string_view suffix_m16int { "" };
const std::string_view suffix_m32int { "l" };
const std::string_view suffix_m64int { "ll" };
