...
using Instruction3_Type1 = Instruction_x
<
...
using Instruction3_Type2 = Instruction_x
<
    Operands_reg<r16>,
    Operands_reg<r32>,
    Operands_reg<r64>
...
using Instruction3_Type3 = Instruction_x
<
...
using Instruction3_Type4 = Instruction_x
<
    Operands_reg_reg<xmm, xmm, no_suffix>,
...
using Instruction3_Type5 = Instruction_x
<
    Operands_reg_reg<xmm, xmm, no_suffix>,
...
using Instruction3_Type6 = Instruction_x
<
...
using Instruction3_Type7 = Instruction_x
<
...
using Instruction3_Type8 = Instruction_x
<
    Operands_mem<m32fp, suffix_m32fp>,
    Operands_mem<m64fp, suffix_m64fp>,
...
using Instruction3_Type9 = Instruction_x
<
...
using Instruction3_Type10 = Instruction_x
<
    Operands_reg_reg_imm<r32, xmm, imm8>,
    Operands_reg_reg_imm<r64, xmm, imm8>,
