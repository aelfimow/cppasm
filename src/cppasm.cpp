...
Instruction4_Type21 VMOVSHDUP { asmout, "vmovshdup" };
Instruction4_Type21 VMOVSLDUP { asmout, "vmovsldup" };
Instruction4_Type21 VMOVDDUP { asmout, "vmovddup" };
...
Instruction2_Type24 VMASKMOVPS { asmout, "vmaskmovps" };
Instruction2_Type24 VMASKMOVPD { asmout, "vmaskmovpd" };
...
Instruction4_Type6 VMOVQ { asmout, "qmovq" };
